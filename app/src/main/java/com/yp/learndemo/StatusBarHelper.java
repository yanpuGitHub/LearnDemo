...
import com.yp.baseframworklib.utils.ScreenUtils;
...
public class StatusBarHelper {
    ...
    private static boolean mIsOtherDevices;
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        //其他机型则改变状态栏的底色
        mIsOtherDevices = true;
        translucent(activity, 0x33000000);
        return false;
    }
